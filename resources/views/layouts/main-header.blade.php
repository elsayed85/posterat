					...
					<div class="main-header-right">
						<ul class="nav">
							<li class="">
							 ...
							 $second_lang = (App::getLocale() =='ar')?'en':'ar';
								//i can do it fast in blade (App::getLocale() =='ar')?'en':'ar';
								//but to every one would know what nice thing *Amr Moro*
								@endphp
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="{{route('language',$first_lang)}}" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/'.$first_lang.'.jpg')}}" alt="img"></span>
										<div class="my-auto">
											<strong class="mr-2 ml-2 my-auto">
												@lang('theme.'.$first_lang)
											</strong>
										</div>
									</a>
									<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
										<a href="{{route('language',$second_lang)}}" class="dropdown-item d-flex ">
											<span class="avatar  ml-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/'.$second_lang.'.jpg')}}" alt="img"></span>
											<div class="d-flex">
												<span class="mt-2">
												@lang('theme.'.$second_lang)
												</span>
											</div>
										</a>
