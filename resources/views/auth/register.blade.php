                    ...
                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-grid">
                            <div class="main-signup-header">
                                <h2 class="text-primary"> @lang('theme.register') </h2>
                                {{--<h5 class="font-weight-normal mb-4">It's free to signup and only takes a minute.</h5>--}}
                                <form method="POST" action="{{ route('register') }}">
                                    @csrf

                                    <div class="form-group row">
                                        <label for="first_name" class="col-md-4 col-form-label text-md-right">@lang('theme.first name') <span class="required">*</span> </label>
                                    ...
                                    <div class="form-group row">
                                        <label for="last_name" class="col-md-4 col-form-label text-md-right">@lang('theme.last name') <span class="required">*</span> </label>
                                    ...
                                    <div class="form-group row">
                                        <label for="phone" class="col-md-4 col-form-label text-md-right">@lang('theme.phone') <span class="required">*</span> </label>
                                    ...
                                    <div class="form-group row">
                                        <label for="email" class="col-md-4 col-form-label text-md-right">@lang('theme.email address') <span class="required">*</span> </label>
                                    ...
                                    <div class="form-group row">
                                        <label for="password" class="col-md-4 col-form-label text-md-right">@lang('theme.password') <span class="required">*</span> </label>
                                    ...
                                    <div class="form-group row">
                                        <label for="password-confirm" class="col-md-4 col-form-label text-md-right">@lang('theme.re-password') <span class="required">*</span></label>
                                    ...
                                    <div class="form-group row">
                                        <label for="bio" class="col-md-4 col-form-label text-md-right">@lang('theme.bio') </label>

                                        <div class="col-md-6">
                                            <input id="bio" type="text" class="form-control @error('bio') is-invalid @enderror" name="bio" value="{{ old('bio') }}" autocomplete="bio" placeholder="@lang('theme.optional')">
                                    ...
                                    <div class="col-md-6">
                                        <div class="checkbox">
                                            <div class="custom-checkbox custom-control">
                                                ...
                                                <label for="checkbox-2" class="custom-control-label mt-1">@lang('theme.agree') <a href="{{url('pages/4')}}"> @lang('theme.terms & conditions')</a></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="main-signup-footer mt-5">
                                    <p>@lang('theme.already have an account?') <a href="{{ route('login')}}">@lang('theme.sign in')</a></p>
                                </div>
                            </div>
                        </div>
                        <!-- Form -->
