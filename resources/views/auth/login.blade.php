                        ...
                        <div class="form-grid">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <label>@lang('theme.email or phone')</label>
                                </div>
                                <input id="email" placeholder="@lang('theme.enter') @lang('theme.email or phone')" type="text" class="form-control @error('email') is-invalid @enderror" name="login" value="{{ old('login') }}" required autocomplete="login" autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="password" placeholder="@lang('theme.enter') @lang('theme.password')"  type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
...
<br>
                                ...
                                <a href="{{route('register')}}" class="btn btn-default btn-lg btn-block">
                                    @lang('theme.register') @lang('theme.new account')
                                </a>
                                <div class="row">
                                        <a class="btn btn-block" href="{{route('password.request')}}">@lang('theme.reset password') </a>
                                </div>
