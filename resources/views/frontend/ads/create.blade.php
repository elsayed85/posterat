                            ...
                            <form action="{{route('ads.store')}}" method="post" class="submit-form" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                        ...
                                        <select class="form-control" name="city_id">
                                            ...
                                            @foreach ($cities as $city)
                                                <option value="{{ $city->id }}" @if(old('city_id')) selected @endif>{{ $city->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
                                        ...
                                        <input type="text" name="title" class="form-control" placeholder="{{trans('theme.enter')}} {{trans('theme.a proper ad title')}}" value="{{old('title')}}">
                                        {{--@error('title')--}}
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
                                        ...
                                        <div class="skin-minimal">
                                            <div id="cost" @if(old('cost_hide')) style="display: none;" @endif>
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" name="cost_hide" value="1" id="cost_hide" @if(old('cost_hide')) checked @endif>
