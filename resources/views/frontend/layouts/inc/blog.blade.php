            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="blog-post">
                            <div class="post-img">
                                <a href="#"> <img class="img-responsive" alt="" src="{{asset(trans('theme.path').'/images/blog/1.jpg')}}"> </a>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="blog-post">
                            <div class="post-img">
                                <a href="#"> <img class="img-responsive" alt="" src="{{asset(trans('theme.path').'/images/blog/2.jpg')}}"> </a>
                            </div>
                            <div class="post-info"> <a href="">Aug 30, 2017</a> <a href="#">23 comments</a> </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="blog-post">
                            <div class="post-img">
                                <a href="#"> <img class="img-responsive" alt="" src="{{asset(trans('theme.path').'/images/blog/3.jpg')}}"> </a>
                            </div>
                            <div class="post-info"> <a href="">Aug 30, 2017</a> <a href="#">23 comments</a> </div>
