<footer class="footer-area no-bg">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-7 col-sm-6 col-xs-12 column">
                            <div class="footer-widget about-widget">
                                <div class="logo">
                                    <a href="{{url('/')}}"><img alt="" class="img-responsive" src="{{asset(trans('theme.path').'/images/logo.png')}}"></a>
                                </div>
                                <div class="text">
                                ...
                                <ul class="contact-info">
                                    ...
                                    <li><span class="icon fa fa-envelope-o"></span> contant@AmrMoro.com</li>
                            ...
                            <div class="footer-widget news-widget">
                                ...
                                <div class="news-post">
                                    ...
                                    <div class="news-content">
                                        <figure class="image-thumb"><img alt="" src="{{asset(trans('theme.path').'/images/blog/popular-2.jpg')}}"></figure>
                                ...
                                <div class="news-post">
                                    <div class="icon"></div>
                                    <div class="news-content">
                                        <figure class="image-thumb"><img alt="" src="{{asset(trans('theme.path').'/images/blog/popular-1.jpg')}}"></figure>
                                        <a href="#">If you need a crown or lorem an implant you will pay it gap it</a>
                                    </div>
                                    <div class="time">July 2, 2014</div>
                                </div>
    ...
    <div class="footer-copyright">
        <div class="container clearfix">
            <!--Copyright-->
            <div class="copyright text-center">Copyright {{get_setting('site_year')}} © Website Created By <a href="{{config('app.url')}}" target="_blank">{{get_setting('site_designedby')}}</a> All Rights Reserved</div>
        </div>
    </div>
</footer>