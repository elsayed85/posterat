        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <ul class="menu-logo">
                        <li>
                            <a href="index.html"><img src="{{asset(trans('theme.path').'/images/logo-1.png')}}" alt="logo"> </a>
                        </li>
                    </ul>
                    <!-- menu links -->
                    <ul class="menu-links">
                        ...
                        <li>
                            <a href="javascript:void(0)">Ad Detail <i class="fa fa-angle-down fa-indicator"></i></a>
                            <!-- drop down multilevel  -->
                            <ul class="drop-down-multilevel">
                                <li><a href="single-page-listing.html">Single Ad Detail</a></li>
                                <li><a href="single-page-listing-2.html">Single Ad 2</a></li>
