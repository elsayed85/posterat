<footer class="footer-area no-bg">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-7 col-sm-6 col-xs-12 column">
                            <div class="footer-widget about-widget">
                                <div class="logo">
                                    <a href="index.html"><img alt="" class="img-responsive" src="{{asset(trans('theme.path').'/images/logo.png')}}"></a>
                                </div>
                                <div class="text">
    ...
    <div class="footer-copyright">
        <div class="container clearfix">
            <!--Copyright-->
            <div class="copyright text-center">Copyright 2017 © Website Created By <a href="{{config('app.url')}}" target="_blank">{{get_setting('site_designedby')}}</a> All Rights Reserved</div>
        </div>
    </div>
</footer>