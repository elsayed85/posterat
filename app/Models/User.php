...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'first_name', 'last_name', 'phone', 'email', 'password', 'bio','whatsapp',
        'usual_balance', 'paid_balance', 'usual_expired_at', 'usual_expired_at', 'photo', 'photo_thumb','email_verified_at'
    ];
